...
INSERT INTO videoDB.Videos(user_id,video_name,video_token,is_visible) VALUES (2,'LOL2','l',TRUE);
commit;

ALTER TABLE videoDB.Videos ADD COLUMN dcreated timestamp default CURRENT_TIMESTAMP not null;
